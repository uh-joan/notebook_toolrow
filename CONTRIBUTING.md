...
Hey! 👋 Thanks for checking out **SourceBook**. We're stoked that you're interested in helping improve the project. Whether it's fixing bugs, suggesting features, improving docs, or just joining the conversation — every bit helps.

## 🧠 Before You Start

**Join Our Discord**  
Want to stay in the loop, ask questions, or get feedback before starting something?  
Hop into the official SourceBook community:  
...
🔗 [SourceBook GitHub Project Roadmap](https://github.com/users/MODSetter/projects/2)
...
SourceBook consists of three main components:
...
- **Share SourceBook** with your community
- **Provide feedback** on Discord
- **Help triage issues** and validate bug reports
- **Improve documentation** and examples
- **Write tutorials** or blog posts about SourceBook
...
By contributing to SourceBook, you agree that your contributions will be licensed under the same license as the project.

---

**Thank you for contributing to SourceBook!** 🚀  
